        ...
        <div className="dashboard-header-stats">
          ...
          <div className="dashboard-stat-item">
            ...
            <span className={`dashboard-stat-value dashboard-online`}>
              {metrics.onlineServers}
            </span>
          </div>
          <div className="dashboard-stat-item">
            <span className="dashboard-stat-label">Alerts</span>
            <span
              className={`dashboard-stat-value ${metrics.activeAlertsCount > 0 ? 'dashboard-warning' : 'dashboard-online'}`}
            >
        ...
        <div className="dashboardStatsGrid">
          <div className="dashboardStatCard">
            ...
            <div className="dashboardStatFooter">
              <span
                className={`dashboardBadge ${metrics.totalServers > 0 ? 'dashboardBadgeSuccess' : 'dashboardBadgeNeutral'}`}
              >
          ...
          <div className="dashboardStatCard">
            ...
            <div className="dashboardStatValue">
              {metrics.onlineServers}
              <span className="dashboardStatUnit">/{metrics.totalServers}</span>
            </div>
            <div className="dashboardStatFooter">
              ...
              <span
                className={`dashboardBadge ${metrics.uptimePercentage >= 90 ? 'dashboardBadgeSuccess' : metrics.uptimePercentage >= 70 ? 'dashboardBadgeWarning' : 'dashboardBadgeError'}`}
              >
          ...
          <div className="dashboardStatCard">
            ...
            <div className="dashboardStatFooter">
              {metrics.criticalAlerts > 0 && (
                <span className="dashboardAlertCount dashboardAlertCountCritical">
                  {metrics.criticalAlerts} critical
                </span>
              )}
              {metrics.warningAlerts > 0 && (
                <span className="dashboardAlertCount dashboardAlertCountWarning">
                  {metrics.warningAlerts} warnings
                </span>
              )}
              {metrics.activeAlertsCount === 0 && (
                <span className="dashboardBadge dashboardBadgeSuccess">
                  All systems normal
                </span>
              )}
            </div>
          ...
          <div className="dashboardStatCard">
            ...
            <div className="dashboardStatValue">
              {metrics.avgCpuUsage}
              <span className="dashboardStatUnit">%</span>
            </div>
            <div className="dashboardStatFooter">
              ...
              <span
                className={`dashboardBadge ${metrics.avgCpuUsage < 70 ? 'dashboardBadgeSuccess' : metrics.avgCpuUsage < 85 ? 'dashboardBadgeWarning' : 'dashboardBadgeError'}`}
              >
            ...
            <div className="activity-feed">
              {recentActivity.length > 0 ? (
                ...
                <div className="empty-state">
                  ...
                  <p>
                    Activity will appear here as servers report metrics and
          ...
          <div className="panel">
            ...
            <div className="health-grid">
              <div className="health-item">
                ...
                <div
                  className={`health-status ${metrics.onlineServers === metrics.totalServers && metrics.totalServers > 0 ? 'healthy' : 'warning'}`}
                >
              ...
              <div className="health-item">
                ...
                <div
                  className={`health-status ${metrics.criticalAlerts === 0 ? 'healthy' : 'critical'}`}
                >
                  <div className="status-dot"></div>
                  <span>
                    {metrics.criticalAlerts === 0
              ...
              <div className="health-item">
                ...
                <div
                  className={`health-status ${metrics.avgCpuUsage < 70 ? 'healthy' : metrics.avgCpuUsage < 85 ? 'warning' : 'critical'}`}
                >
                  <div className="status-dot"></div>
                  <span>
              ...
              <div className="health-item">
                ...
                <div
                  className={`health-status ${metrics.offlineServers === 0 ? 'healthy' : 'warning'}`}
                >
                  <div className="status-dot"></div>
                  <span>
                    {metrics.totalServers === 0
